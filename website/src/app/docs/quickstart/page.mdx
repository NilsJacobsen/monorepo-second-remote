...
<Tabs items={['Next.js', 'React', 'Vanilla JS', 'Vue', 'Svelte']}>
  <Tabs.Tab>
   ...
   - [React Wrapper](/docs/react-wrapper) — Full documentation for the React wrapper
   - [React Wrapper API Reference](/docs/react-wrapper/api) — Full documentation for the React wrapper API
   - [Legit SDK Examples](/showcase) — Explore Legit SDK Starters and Examples
   - [Filesystem API Reference](/docs/api) — See all available paths in the file system
