...
Legit uses Tailwind CSS which provides access to the Zinc color scale for UI elements. Commonly used values include:
...
Note: These are available through Tailwind CSS utilities but are not explicitly defined as CSS variables in the design system.
...
- **Content Width**: Article content is constrained to a maximum width of 800px for optimal readability
