...
export const LegitHeader = ({ handleShare }: { handleShare: () => void }) => {
  return (
    <div className="flex justify-between items-center h-14 border-b border-gray-200 px-4">
...
export const LegitFooter = () => {
  ...
  return (
    <div className="flex justify-between items-center text-sm text-gray-600 h-14 border-t border-gray-200 px-4">
      <p>
        This is made with{' '}
        <Link
